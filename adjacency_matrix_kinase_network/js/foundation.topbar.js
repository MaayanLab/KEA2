;(function ($, window, document, undefined) {
  'use strict';
  //console.log('working on foundation.topbar.js');
  ...
  Foundation.libs.topbar = {
    ...
    settings : {
      ...
      back_text: 'Back',
      //is_hover is originally set to true
      is_hover: false,
    ...
    init : function (section, method, options) {
      ...
      $('[data-topbar]', this.scope).each(function () {
        ...
        if (settings.is_hover) {
          ...
          // setting this to addClass enabels hover
