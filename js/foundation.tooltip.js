;(function ($, window, document, undefined) {
  ...
  Foundation.libs.tooltip = {
    ...
    reposition : function (target, tip, classes) {
      ...
      // objPos(tip, (target.offset().top + target.outerHeight() + 20), 'auto', 'auto', target.offset().left, width);
      objPos(tip, (target.offset().top + target.outerHeight() + 20), 'auto', 'auto', (target.offset().left - tip.outerWidth() - nubHeight), width);

      objPos(tip, (target.offset().top - 5), 'auto', 'auto', (target.offset().left - tip.outerWidth() - nubHeight), width)
